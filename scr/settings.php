...
//define('C_REST_CLIENT_ID','3un4fkidg0l304twvwzaxanp22iimran');//Application ID
define('C_REST_CLIENT_SECRET','vbfjjq12tnrx2dii');//Application key
define('C_REST_WEB_HOOK_URL','https://crm.po-karton.com/rest/1/vbfjjq12tnrx2dii/');//url on creat Webhook
//define('C_REST_LOGS_DIR', __DIR__ .'/logs/'); //directory path to save the log
